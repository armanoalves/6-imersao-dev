...
var nomeFilmes = ['School of Rock','A chegada','AranhaVerso', '10 coisas que odeio em você', 'Matrix']

var divisona = document.querySelector('.filmes')
...
function mostraImagens() {
	...
	for (var i = 0; i < listaFilmes.length; i++) {
		...
		divisona.appendChild(div);
  }
}

function adicionaFilmes() {
	var linkFilme = document.querySelector('#link-do-filme').value;
	console.log(linkFilme);
	
	var nomeFilme = document.querySelector('#nome-do-filme').value;
	console.log(nomeFilme);
 	if (listaFilmes.includes(linkFilme) || nomeFilmes.includes(nomeFilme)) {
		alert('Já tem po!')
	} else {
